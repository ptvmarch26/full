...
const DEMO_DEPTH = parseInt(process.env.DEMO_DEPTH) || 10
const ELECTION_ID = 'ELC2026'

const DATA_DIR   = path.join(__dirname, '..', 'data')
const OUT_DB      = path.join(DATA_DIR, 'voter_data_for_db_1000.json')
const OUT_SECRETS = path.join(DATA_DIR, 'voter_secrets_for_script_1000.json')
